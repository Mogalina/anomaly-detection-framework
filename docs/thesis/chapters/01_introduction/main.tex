...
The strongest empirical result is the federated LSTM-AE detection performance,
...
Artificial Intelligence tools were used throughout the development of this 
thesis in a supportive capacity. Large Language Models assisted with literature 
exploration, brainstorming alternative architectural and implementation 
approaches, code review discussions, and improving the clarity, grammar, and 
academic style of the written manuscript. All system design decisions, 
algorithmic implementations, experimental configurations, evaluation 
procedures, and conclusions were independently developed, validated, and 
